...
# ╔═╡ b990f640-d414-4e26-9d03-c4223bb16adf
# Se puede observar que al mover el cursor los valores cambian junto con el movimiento.
# Los primeros números que aparecen entre corchetes "[]" son las coordenadas
# Los siguientes números, que son 3 coordenadas del color y a cada valor le corresponde una letra, las cuales son iniciales de cada color (R=red/rojo, G=gray/gris, B=blue/azul). 
...
# ╔═╡ bdaa25ed-0fb9-4a4c-a7b0-56ed282da8d1
# Al final, las imagenes digitales son arreglos
...
# ╔═╡ 904f392e-8c72-4121-9746-ef6f3625215c
img = [
    RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0)
    RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0)
    RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0)
    RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0)
   RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0)
	RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(0.0, 0.0, 0.0) RGB(0.0, 0.0, 0.0)

	RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0)

	RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(1.0, 1.0, 0.0) RGB(0.0, 0.0, 0.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0) RGB(1.0, 1.0, 1.0)
